...
class Trainer(object):
    ...
    def __init__(self):
        ...
        # set device. `config.train.cuda` should be a list of gpu device ids, None or [] for cpu only.
        self.device = self.config.train.cuda if isinstance(self.config.train.cuda, list) else []
